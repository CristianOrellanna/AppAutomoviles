...
public class GestorDB extends SQLiteOpenHelper{
        ...
        public static abstract class TablaDatos implements BaseColumns{
            public static final String NOMBRE_TABLA = "Automovil";
    ...
    public static final String DATABASE_NAME="BaseAutomovil.db";

    public GestorDB(Context context){super(context, DATABASE_NAME, null, DATABASE_VERSION);}
    @Override
